...
static void MX_GPIO_Init(void)
	...
	HAL_GPIO_WritePin(GPIOB, Ready_Pin | Data_Pin | UserGreenLED_Pin | UserRedLED_Pin, GPIO_PIN_RESET);

	/*Configure GPIO pins : Ready_Pin Data_Pin UserGreenLED_Pin UserRedLED_Pin */
	GPIO_InitStruct.Pin = Ready_Pin | Data_Pin | UserGreenLED_Pin | UserRedLED_Pin;
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin) {
	if (GPIO_Pin == UserBtn_Pin || GPIO_Pin == MPU_INT_Pin) {
