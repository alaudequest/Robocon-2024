...
int main(void)
{
  ...
  MCT8316_PackageControlWord(&mct8316);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(MCT_RST_GPIO_Port, MCT_RST_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : MCT_RST_Pin */
  GPIO_InitStruct.Pin = MCT_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(MCT_RST_GPIO_Port, &GPIO_InitStruct);
