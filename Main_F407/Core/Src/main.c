...
//							}
					...
					else if (step == 6)
					{
						...
						{
							AngleNow = -140;
							process_Accel_FloatingEnc3( -140, 0.6, 2200, 0.1, 0, 3,5);
						}
					else if (step == 9)
					{
//						Reset_MPU_Angle();
...
//						process_DetectBall();
					...
					else if (step == 14)
					{
						...
						{
							AngleNow = -225;
							process_Accel_FloatingEnc3( -225, 0.8,1000 , 0.1, -3, 3,5);
						}
					else if(step == 16)
						{
						...
						{
						AngleNow = 48;
						process_Accel_FloatingEnc3( 48, 0.7,10000 , 0.1, 0, 3,5);
					...
					{
//						process_PD_Critical();
						process_Accel_FloatingEnc3( 40, 0.6,3500 , 0.1, -3, 3,5);
//					}
						...
						else if(step == 19)
						{
							if(siloNum != 0)
							{
								process_Accel_FloatingEnc3( 45,0.5,siloNum*1600 , 0.1, -1, 3,5);
							}else{
								step ++;
							}
						}
						...
						{
							AngleNow = -135;
							process_Accel_FloatingEnc3( -136, 0.6,6000 , 0.1, 0, 3,5);
						}
						else if (step == 23)
						{
						...
						{
							AngleNow = -140;
							process_Accel_FloatingEnc3( -140, 0.6, 2500, 0.1, 0, 3,5);
						}
						else if (step == 26)
						{
							step = 9;
...
//					else if (step == 8)
//						{
//							process_Accel_FloatingEnc3( -140, 0.8, 1500, 0.1, 0, 3);
//						}
//					else if (step == 9)
//						{
//							process_PD_Critical();
...
//						process_PD_Critical();
//						siloNum = 0;
//						process_Accel_FloatingEnc3( 43, 0.8,3500 , 0.1, -1, 3);
//					}
//					else if(step == 19)
//					{
...
//					{
//						AngleNow = 90;
//						process_Accel_FloatingEnc3( 90, 0.6, 400, 0.1, 0, 3);
//					}
//					else if(step == 61)
//					{
//						process_Ball_Out();
...
//					{
//						process_PD_OnStrainghtPath();
//						process_Accel_FloatingEnc4( 0, 0, 0, 0, -100, 3);
//					}
//					else if (step == 63)
//					{
//						process_ReleaseBall();
